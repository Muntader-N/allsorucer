...
async def _(event):
	if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
		await event.edit(
		"**قائمة اوامر بوت وعد :\n ★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★\n\n-( `.بخشيش وعد` + عدد المرات )\n> يقوم هذا الامر بتجميع بخشيش في بوت وعد بداخل المجموعة التي كتبت فيها الامر\n\n-( `.راتب وعد` + عدد المرات )\n> يقوم هذا الامر بتجميع الراتب في بوت وعد بداخل المجموعة التي كتبت فيها الامر\n\n-( `.كلمات وعد` + عدد المرات )\n> يقوم هذا الامر بعلب لعبة الكلمات في بوت وعد بداخل المجموعة التي كتبت فيها الامر\nملاحظة : احذر وضع الكثير من عدد مرات لكي تحظر من الرسائل !\n\n-( `.استثمار وعد` + عدد المرات )\n> يقوم هذا الامر باستثمار الفلوس في بوت وعد بداخل المجموعة التي كتبت فيها الامر\n\n★•┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉•★**"
